...
class AliceCore {
  ...
  Future _showLocalNotification() async {
    ...
    final androidPlatformChannelSpecifics = AndroidNotificationDetails(channelId, channelName,
    ...
    await _flutterLocalNotificationsPlugin.show(
        0, "Alice (total: ${callsSubject.value.length} requests)", message, platformChannelSpecifics,
        payload: "");
